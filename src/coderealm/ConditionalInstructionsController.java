 ...
 * @author Ferdushe
 */
public class ConditionalInstructionsController implements Initializable {
    ...
    private void goNext(MouseEvent event) {
         try{
                FXMLLoader loader = new FXMLLoader(getClass().getResource("Iterative Statements.fxml"));
