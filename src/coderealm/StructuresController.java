...
public class StructuresController implements Initializable {
   ...
   void goBack(MouseEvent event) throws IOException {
    ...
    private void goPrev(MouseEvent event) {
        try{
                FXMLLoader loader = new FXMLLoader(getClass().getResource("Functions and Recursion.fxml"));
    ...
    private void goNext(MouseEvent event) {
        try{
                FXMLLoader loader = new FXMLLoader(getClass().getResource("File Handling.fxml"));
